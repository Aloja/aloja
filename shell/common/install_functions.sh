...
vm_install_base_packages() {
  ...
  if check_bootstraped "$bootstrap_file" ""; then
    ...
    install_packages "ssh dsh rsync sshfs sysstat gawk libxml2-utils ntp wget curl unzip wamerican bwm-ng dstat iotop gcc make bc" "update" #wamerican is for hivebench, gcc for tpch
