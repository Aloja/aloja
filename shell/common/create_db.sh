...
insert ignore into filters_presets(id,name,URL,preset,description,screen) values (7,'HDI number of nodes', 'http://localhost:8080/nodeseval?benchs[]=wordcount&bench_types[]=HiBench&types[]=PaaS&filters[]=valid&filters[]=filters&allunchecked=&selected-groups=&datefrom=&dateto=&minexetime=50&maxexetime=', 0, 'HDI number of nodes evaluation', 'Number of Nodes Evaluation');
"
