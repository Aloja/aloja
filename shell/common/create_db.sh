...
CREATE TABLE `HDI_JOB_details` (
  ...
  `COMMITTED_HEAP_BYTES` int(11) NOT NULL,
  `CPU_MILLISECONDS` int(11) NOT NULL,
  `FAILED_MAPS` int(11) NOT NULL,
  `FAILED_REDUCES` int(11) NOT NULL,
  `FAILED_SHUFFLE` int(11) NOT NULL,
  `FILE_BYTES_READ` int(11) NOT NULL,
  `FILE_BYTES_WRITTEN` int(11) NOT NULL,
  `FILE_LARGE_READ_OPS` int(11) NOT NULL,
  `FILE_READ_OPS` int(11) NOT NULL,
  `FILE_WRITE_OPS` int(11) NOT NULL,
  `FINISHED_MAPS` int(11) NOT NULL,
  `FINISH_TIME` int(11) NOT NULL,
  `GC_TIME_MILLIS` int(11) NOT NULL,
  `JOB_PRIORITY` int(11) NOT NULL,
  `LAUNCH_TIME` int(11) NOT NULL,
  `MAP_INPUT_RECORDS` int(11) NOT NULL,
  `MAP_OUTPUT_RECORDS` int(11) NOT NULL,
  `MB_MILLIS_MAPS` int(11) NOT NULL,
  `MERGED_MAP_OUTPUTS` int(11) NOT NULL,
  `MILLIS_MAPS` int(11) NOT NULL,
  `OTHER_LOCAL_MAPS` int(11) NOT NULL,
  `PHYSICAL_MEMORY_BYTES` int(11) NOT NULL,
  `SLOTS_MILLIS_MAPS` int(11) NOT NULL,
  `SPILLED_RECORDS` int(11) NOT NULL,
  `SPLIT_RAW_BYTES` int(11) NOT NULL,
  `SUBMIT_TIME` int(11) NOT NULL,
  `TOTAL_LAUNCHED_MAPS` int(11) NOT NULL,
  `TOTAL_MAPS` int(11) NOT NULL,
  `TOTAL_REDUCES` int(11) NOT NULL,
  `USER` int(11) NOT NULL,
  `VCORES_MILLIS_MAPS` int(11) NOT NULL,
  `VIRTUAL_MEMORY_BYTES` int(11) NOT NULL,
  `WASB_BYTES_READ` int(11) NOT NULL,
  `WASB_BYTES_WRITTEN` int(11) NOT NULL,
  `WASB_LARGE_READ_OPS` int(11) NOT NULL,
  `WASB_READ_OPS` int(11) NOT NULL,
  `WASB_WRITE_OPS` int(11) NOT NULL,
...
CREATE TABLE `HDI_JOB_tasks` (
  ...
  `SPILLED_RECORDS` int(11) NOT NULL,
  `SPLIT_RAW_BYTES` int(11) NOT NULL,
  `TASK_ERROR` int(11) NOT NULL,
  `TASK_FINISH_TIME` int(11) NOT NULL,
  `TASK_START_TIME` int(11) NOT NULL,
